...
/*                                           GPIOA Aperture                                                          */
    ...
    #define GPIO_PORTA_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTA_AHB_BASE_ADDRESS + 0x500))
#elif   GPIOA_APERTURE == APB
    /*                              GPIOA Settings Struct of registers                                               */
    #define GPIO_PORTA_REGISTER_SET1                    ((volatile GPIO_REG_SET1*)(GPIO_PORTA_APB_BASE_ADDRESS + 0x400))
    #define GPIO_PORTA_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTA_APB_BASE_ADDRESS + 0x500))
#else
...
/*                                           GPIOB Aperture                                                          */
    ...
    #define GPIO_PORTB_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTB_AHB_BASE_ADDRESS + 0x500))
#elif   GPIOB_APERTURE == APB
    /*                              GPIOB Settings Struct of registers                                               */
    #define GPIO_PORTB_REGISTER_SET1                    ((volatile GPIO_REG_SET1*)(GPIO_PORTB_APB_BASE_ADDRESS + 0x400))
    #define GPIO_PORTB_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTB_APB_BASE_ADDRESS + 0x500))
#else
...
/*                                           GPIOC Aperture                                                          */
    ...
    #define GPIO_PORTC_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTC_AHB_BASE_ADDRESS + 0x500))
#elif   GPIOC_APERTURE == APB
    /*                              GPIOC Settings Struct of registers                                               */
    #define GPIO_PORTC_REGISTER_SET1                    ((volatile GPIO_REG_SET1*)(GPIO_PORTC_APB_BASE_ADDRESS + 0x400))
    #define GPIO_PORTC_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTC_APB_BASE_ADDRESS + 0x500))
#else
...
/*                                           GPIOD Aperture                                                          */
    ...
    #define GPIO_PORTD_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTD_AHB_BASE_ADDRESS + 0x500))
#elif   GPIOD_APERTURE == APB
    /*                              GPIOD Settings Struct of registers                                               */
    #define GPIO_PORTD_REGISTER_SET1                    ((volatile GPIO_REG_SET1*)(GPIO_PORTD_APB_BASE_ADDRESS + 0x400))
    #define GPIO_PORTD_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTD_APB_BASE_ADDRESS + 0x500))
#else
...
/*                                           GPIOE Aperture                                                          */
    ...
    #define GPIO_PORTE_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTE_AHB_BASE_ADDRESS + 0x500))
#elif   GPIOE_APERTURE == APB
    /*                              GPIOE Settings Struct of registers                                               */
    #define GPIO_PORTE_REGISTER_SET1                    ((volatile GPIO_REG_SET1*)(GPIO_PORTE_APB_BASE_ADDRESS + 0x400))
    #define GPIO_PORTE_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTE_APB_BASE_ADDRESS + 0x500))
#else
...
/*                                           GPIOF Aperture                                                          */
    ...
    #define GPIO_PORTA_REGISTER_SET1                    ((volatile GPIO_REG_SET1*)(GPIO_PORTF_AHB_BASE_ADDRESS + 0x400))
    #define GPIO_PORTA_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTF_AHB_BASE_ADDRESS + 0x500))
#elif   GPIOF_APERTURE == APB
    /*                              GPIOF Settings Struct of registers                                               */
    #define GPIO_PORTA_REGISTER_SET1                    ((volatile GPIO_REG_SET1*)(GPIO_PORTF_APB_BASE_ADDRESS + 0x400))
    #define GPIO_PORTA_REGISTER_SET2                    ((volatile GPIO_REG_SET1*)(GPIO_PORTF_APB_BASE_ADDRESS + 0x500))
#else
